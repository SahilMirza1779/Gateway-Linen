    ...
    <div className="min-h-screen bg-[#F0EAE1] py-12 px-4 sm:px-6 lg:px-8 font-sans relative">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8 flex justify-between items-center">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 text-xs font-bold uppercase tracking-wider rounded-xl transition-all cursor-pointer shadow-2xs"
          >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-3 border border-[#E5DCD0] rounded-xl text-xs text-gray-800 focus:outline-none focus:border-[#B58E58] bg-[#FFFDF9] transition-all shadow-2xs"
                    required
                  />
                </div>
              </div>
        ...
        {/* IMPROVED SAVED ADDRESSES SECTION (Soft Off-White Theme Match) */}
        <div className="bg-[#F7F2EB] rounded-[32px] p-8 border border-[#E5DCD0] shadow-xl mb-8">
          <div className="flex items-center justify-between mb-6 pb-4 border-b border-[#E5DCD0]">
            <div className="flex items-center gap-2 text-[#031D44]">
              <div className="w-9 h-9 bg-[#031D44]/10 text-[#031D44] rounded-xl flex items-center justify-center">
          ...
          {loadingAddresses ? (
            ...
            <div className="text-center py-12 bg-[#FFFDF9] rounded-2xl border border-dashed border-[#E5DCD0]">
            ...
            <div className="max-h-[460px] overflow-y-auto pr-1 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {addresses.map((addr) => (
                  <div
                    key={addr.AddressId}
                    className="p-5 bg-[#FFFDF9] rounded-2xl border border-[#E5DCD0] hover:border-[#B58E58] flex flex-col justify-between shadow-2xs transition-all group relative overflow-hidden"
                  >
                    ...
                    <div className="flex gap-2.5 pt-3 border-t border-gray-100">
                      <button
                        ...
                        className="flex-1 py-2.5 bg-white hover:bg-[#031D44] hover:text-white text-[#031D44] text-[11px] font-bold tracking-wider uppercase rounded-xl border border-gray-200 hover:border-[#031D44] transition-all cursor-pointer flex items-center justify-center gap-1.5 shadow-2xs"
                      >
                        <FiEdit2 size={13} /> Edit
                      </button>
                      <button
                        onClick={() => handleDeleteAddress(addr.AddressId)}
                        className="py-2.5 px-3.5 bg-red-50 hover:bg-red-600 hover:text-white text-red-600 text-[11px] font-bold rounded-xl border border-red-200 hover:border-red-600 transition-all cursor-pointer flex items-center justify-center shadow-2xs"
        ...
        <div className="bg-[#F7F2EB] rounded-[32px] p-8 border border-[#E5DCD0] shadow-xl mb-8">
          <div className="flex items-center gap-2 mb-6 pb-4 border-b border-[#E5DCD0] text-[#031D44]">
          ...
          {orders.length === 0 ? (
            ...
            <div className="space-y-4">
              {orders.map((order, idx) => (
                <div
                  key={idx}
                  className="p-5 bg-[#FFFDF9] rounded-2xl border border-[#E5DCD0] flex flex-col md:flex-row justify-between items-start md:items-center gap-4 shadow-2xs"
                >
                  <div>
      ...
      {showAddressModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#F7F2EB] rounded-[28px] max-w-lg w-full p-6 sm:p-8 shadow-2xl border border-[#E5DCD0]">
            <div className="flex justify-between items-center mb-5 pb-3 border-b border-[#E5DCD0]">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#F7F2EB] rounded-[24px] max-w-sm w-full p-8 shadow-2xl border border-[#E5DCD0] text-center">
          ...
          <div className="bg-[#F7F2EB] rounded-[28px] max-w-md w-full p-6 sm:p-8 shadow-2xl border border-[#E5DCD0]">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 px-4 bg-red-600 hover:bg-red-700 text-white text-xs font-bold tracking-widest uppercase rounded-xl shadow-md transition-all cursor-pointer flex items-center justify-center"
              >
